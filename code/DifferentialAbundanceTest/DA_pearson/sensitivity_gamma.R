...
res1 =  matrix(0,nrow = length(gamma.list), ncol = 1)
res2 = matrix(0,nrow = length(gamma.list), ncol = 1)
res3 = matrix(0,nrow = length(gamma.list), ncol = 1)
...
write.csv(res1/step,'gamma_sensitivity.csv')
write.csv(res2/step,'gamma_FDR.csv')
write.csv(res3/step,'gamma_misrate.csv')